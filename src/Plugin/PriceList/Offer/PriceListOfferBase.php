 ...
 */
abstract class PriceListOfferBase extends PluginBase implements PriceListOfferInterface, ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new PriceListOfferBase object.
   *
